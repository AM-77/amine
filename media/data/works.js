const works = [
  {
    "title": "Nyno-UI",
    "desc": "A complete CSS framework based on flexbox.",
    "links": {
  ...
  {
    "title": "react-coder",
    "desc": "A lightweight, reusable code wrapper & editor component for react.",
    "links": {
  ...
  },
  {
    ...
    "desc": "A lightweight (zero-dependency), customizable and animated react floating buttons",
    "links": {
  ...
  },
  {
    ...
    "links": {
      "Client Side": "https://github.com/AM-77/el-mesa",
  ...
  {
    "title": "lil-urls",
    "desc": "A Custom URL Shortener, with node, express, sqlite3, typescript & react.",
    "links": {
      "Client Side": "https://github.com/AM-77/lil-urls",
  ...
  },
  {
    ...
    "desc": "A border-radius generator with react.",
    "links": {
  ...
  {
    "title": "DET",
    "desc": "'Distribution Des Equipments' A web app for selling industrial equipments.",
    "links": {
  ...
  {
    "title": "Liam",
    "desc": "A portfolio template for professional photographer.",
    "links": {
